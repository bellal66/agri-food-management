...
<main class="app-content">
    <div class="bs-component">
        <div class="card">
            <h5 class="card-header">Sell Crop</h5>
                ...
                <div class="row">
                    <div class="col-lg-12">
                    	<div class="buying-crop">
                    		<label><b>Wholesaler Name* &nbsp;&nbsp;</b></label>
                    			...
                    			<?php
                                    ...
                                    if($resultFarmer){
                                    	while($resultFarmerr = $resultFarmer->fetch_assoc()){
                                    		?>
                                    		<option value="<?php echo $resultFarmerr['username'] ?>"></option>
                                    		<?php
                                    	}
                                    }
                    			?>
                    	...
                    	<div>
                    		...
                    		<div>
                    			<label class="btn btn-primary SellingCropSubmit">Submit</label> 
                    		</div>
                    	</div>
                    </div>
                </div>
...
$(document).on('click', '.SellingCropSubmit', function(){
	var sellingCrop = 0;
