...
<main class="app-content">
    <div class="bs-component">
        <div class="card">
            <h5 class="card-header">Problem & Answer</h5>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
    ...
    ?>
        <div class="question">
            ...
            <div class="comment-reply">
                <span class="comment-reply-option fa fa-mail-reply" questionId="<?php echo $resultProblemm['id'] ?>"> <u>Reply</u></span>
                <span class="comment-reply-option fa fa-comment-o"  questionId="<?php echo $resultProblemm['id'] ?>"> <u>Comment</u></span>
            </div>
        </div>
        <?php
