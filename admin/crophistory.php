                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered" id="sampleTable">
                                        ...
                                        <tbody>
                                            <?php
                                            $i=0;
                                                $query = "SELECT * FROM monocrop ORDER BY id ASC";
                                                ...
                                                if($result){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><?php echo $resultRow['areaForFamous']; ?></th>
                                                    </tr>
                                                    <?php
                                                    } 
                                                }
    ...
    <?php
        ...
        if($resultwarehouse){
            while($resultwarehousee = $resultwarehouse->fetch_assoc()){
                ?>
                <option value="<?php echo $resultwarehousee['division'] ?>"><?php echo $resultwarehousee['division']; ?></option>
                <?php
            }
        }
    ?>
...
<script type="text/javascript">
    $('.addCrop').click(function(){
      ...
      html += '<th><input type="text" class="warehouse"  placeholder="Warehouse" list="warehouseList"></th>';
...
<style type="text/css">
    ...
    .cropName, .buyingPrice, .sellingPrice, .warehouse{
        height: 40px;
        width: 150px;
    }
     .description{
